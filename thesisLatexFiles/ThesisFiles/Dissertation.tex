...
\begin{figure}[h!] \label{fig:texasWindProfile}
...
\begin{figure}[h!] \label{fig:windProfileBus122January}
...
\begin{figure}[h!] \label{fig:texasSolarProfile}
	\begin{center}
		\includegraphics[width=0.6\textwidth,keepaspectratio]{texasSolarProfileWithBuses.png}
	  	\caption{Solar Potential for Texas with RTS-96 Bus Locations. Adapted from \cite{texasSolarProfile} }
	\end{center}
\end{figure}
...
\begin{figure}[h!] \label{fig:solarProfileBus112January}
	\begin{center}
		\includegraphics[width=\textwidth,keepaspectratio]{solarPotentialBus112.png}
